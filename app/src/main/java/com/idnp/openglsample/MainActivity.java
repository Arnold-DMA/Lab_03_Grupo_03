...
//        setContentView(mView);
        ...
        //**CAMBIO** CameraView cameraView = new CameraView(this);
        // ...and add it, wrapping the full screen size.

        //**CAMBIO** getWindow().addContentView(cameraView, new WindowManager.LayoutParams(WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.WRAP_CONTENT));
